...
<head>
    ...
    <title>@yield('title', config('app.name', 'SEGURIDAD-SIS'))</title>
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SEGURIDAD SIS</span>
            </a>
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} <a href="#">SEGURIDAD SIS</a>.</strong>
